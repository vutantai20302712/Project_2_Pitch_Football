...
@section('content')
    ...
    @endif
                    <form method="post" action="{{ route('pitch.update', $value->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <br>
                                    <img src="{{ asset('img/' . $value->image) }}" alt="Product Image" id="preview" width="120px" height="150px" style="margin-top: 10px;">
                                    <script>
