        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <form method="post" action="{{ route('admin.store') }}">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputAddress1"><strong>Enter Address</strong></label>
                        <input type="text" class="form-control" id="exampleInputAddress1" aria-describedby="emailHelp" name="address">
                    </div>
                    <div class="mb-3">
